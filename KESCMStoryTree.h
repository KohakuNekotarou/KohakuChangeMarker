...
#ifndef __KESCMStoryTree_h__
#define __KESCMStoryTree_h__

/** Redraw the Story Edits list from whatever KESCMStoryList holds right now.
...
#endif // __KESCMStoryTree_h__

// End, KESCMStoryTree.h.
