...
#include <set>			// the page sets the emitters below are handed

// WHAT A NOTIFICATION CARRIES is defined next door, in a header of its own: the UI's observer
// needs the struct and nothing else on this page (KCMModelChangeObserver.cpp used to include
