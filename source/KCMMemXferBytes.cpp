...
//
//  See KCMMemXferBytes.h for why this exists rather than the SDK's own MemXferBytes.
//
//========================================================================================
...
/* Constructor
*/
KCMMemXferBytes::KCMMemXferBytes()
	: fPosition(0),
...
/* Read
*/
uint32 KCMMemXferBytes::Read(void* buffer, uint32 num)
{
	if (buffer == nil || num == 0)
		return 0;
...
*/
uint32 KCMMemXferBytes::Write(void* buffer, uint32 num)
{
	if (buffer == nil || num == 0)
		return 0;
...
/* Seek
*/
uint64 KCMMemXferBytes::Seek(int64 numberOfBytes, SeekFromWhere fromHere)
{
...
/* Flush
*/
void KCMMemXferBytes::Flush()
{
}

/* GetStreamState
*/
StreamState KCMMemXferBytes::GetStreamState()
{
	return fStreamState;
}
...
/* SetEndOfStream
*/
void KCMMemXferBytes::SetEndOfStream()
{
...
/* GetData
*/
const char* KCMMemXferBytes::GetData() const
{
	if (fBuffer.empty())
		return nil;
	return &fBuffer[0];
...
/* GetSize
*/
uint32 KCMMemXferBytes::GetSize() const
{
	return static_cast<uint32>(fBuffer.size());
}

// End, KCMMemXferBytes.cpp.
