...
#ifndef __KESCMMemXferBytes_h__
#define __KESCMMemXferBytes_h__
...
/** A memory-backed IXferBytes for exporting to a stream that never touches disk.
	@ingroup KESCM
*/
class KESCMMemXferBytes : public IXferBytes
{
public:
	KESCMMemXferBytes();
	virtual ~KESCMMemXferBytes();
...
#endif // __KESCMMemXferBytes_h__

// End, KESCMMemXferBytes.h.
