...
//
//  See KESCMStoryXml.h for what this is for and what must not be passed to it.
//
...
/* ExportStory
*/
bool16 KESCMStoryXml::ExportStory(const UIDRef& storyRef, std::string& utf8Out)
{
	utf8Out.clear();

	KESCMMemXferBytes xferBytes;
