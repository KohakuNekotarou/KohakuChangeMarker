...
//      残る2つ(How to Use... ／ 2ブックが揃わないとき)は **ui/KESCMLoc.h** にある
...
// 旧 KESCM_jaJP.fr が持っていた日本語のうち、**この側に残った1つ**。対のキー
// (kKESCMHideConfirmKey)は KESCMID.h と KESCM_enUS.fr に健在＝英語 UI はそちらを引く。
namespace KESCMJa
{
