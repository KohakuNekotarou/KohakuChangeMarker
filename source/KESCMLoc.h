...
//  環境でも日本語が出る。
//
//  ★★2026-08-06 に対象を **2箇所** へ絞り(ユーザー指示)、2026-08-12 に **4箇所** になった:
...
//    ・Compare Books の確認    … これから比較する2ブックの提示(2026-08-12 ユーザー指示)
//    ・その相手が揃わないとき   … 上の確認の代わりに出る警告
//  ★**線引きは変わっていない＝「アラートで判断を求める文だけ日本語」**。増えた2つも同じ側にある
//    (どちらも CAlert に出る。メニュー/パネル/ステータス行はいまも全ロケール英語)。
...
namespace KESCMJa
{
	...
	// ----- Compare Books の確認(2026-08-12 追加) -----
	// ★下に target: / source: のフルパスが2行続く(KESCMBookRun.cpp が組み立てる)。パスは訳さない。
	const char16_t kBookCompareConfirm[] = u"ブックを比較します。";
