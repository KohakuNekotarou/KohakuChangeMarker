...
//   ㊶★**変更行の ID 欄に「Text」「Cell Text」「Note Text」**(2026-09-19 ユーザー要望「セル内の変更は Cell Text、普通は Text」＝五月蠅ければ外す)。文字の変更行の ID 欄が空だったところに、その語がどこに立つかを出す(overset は `OV Text`)。列幅は最も広い語に合わせて自動。
