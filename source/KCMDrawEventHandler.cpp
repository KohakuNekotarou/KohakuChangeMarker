...
bool16 KCMDrawEventHandler::sMarksOnPage = kFalse;	// ★off, and it has to be: ordinary drawing draws the spread, so leaving it on would draw every mark twice (the header says why it exists)
