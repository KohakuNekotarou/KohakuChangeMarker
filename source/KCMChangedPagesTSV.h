...
//
//  データ源(すべて KCMDrawEventHandler が持つ「比較した時点」の控え ＋ 手動登録):
...
// フライアウト項目 kKCMPopupExportChangedPagesActionID の DoAction から呼ぶ。
