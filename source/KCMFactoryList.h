...
REGISTER_PMINTERFACE(KCMBeforeSaveDocResponder, kKCMBeforeSaveResponderImpl)
REGISTER_PMINTERFACE(KCMAfterOpenDocResponder, kKCMAfterOpenResponderImpl)	// Puts back the ticks and paws an opened document carries	// Restores the spreads hidden by Hide Unchanged before the document is saved. ServiceProvider likewise Adobe-supplied.
