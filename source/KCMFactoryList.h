...
REGISTER_PMINTERFACE(KCMStoryFollowObserver, kKCMStoryFollowObserverImpl)	// (2026-09-25) The lazy observer AddIn'd on kTextStoryBoss (KCMStoryFollowObserver.cpp): the Story Edits list follows an Undo / Redo.
...
// ⛔KCMStoryUndoObserver went on 2026-09-21 with the restore (the panel followed a Ctrl+Z on it).
