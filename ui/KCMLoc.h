...
namespace KCMJa
{
	...
	const char16_t kHint2[] =
		...
		u"・「Export Story Text...」は 1ストーリー＝1つの .docx を書き出します。フレームを選択していればそのストーリーだけ、何も選択していなければ全ストーリーを書き出します\n"
		u"・取り込むと、そのストーリーは Word で見えているとおりになります(Word の変更履歴は承諾した形で。履歴が無くても同じです)。"
		u"書き出した後に InDesign で直した所は上書きされます。Word のコメントは取り込みません\n"
		...
		u"「Restore from Source」(ルビ・圏点・縦中横・割注を Source から戻す)・「Redo」(取り消した変更を Word の内容で書き直す)・"
