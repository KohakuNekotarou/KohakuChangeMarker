...
namespace KCMJa
{
	...
	const char16_t kHint2[] =
		...
		u"・文書に書き込むメニューは変更行の3項目だけです＝「Reject This Import Change」(その行の Import の変更を取り消す)・"
		u"「Restore from Source」(ルビ・圏点・縦中横・割注を Source から戻す)・「Redo from Word」(取り消した変更を Word の内容で書き直す)。どれも Ctrl+Z 1回で戻ります。"
