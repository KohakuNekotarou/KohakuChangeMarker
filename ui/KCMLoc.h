...
namespace KCMJa
{
	...
	const char16_t kHint2[] =
		...
		u"・Ctrl+Z で Import 全体が1回で戻ります。1件ずつも戻せます: Import は変更履歴を付けて、作者「KohakuChangeMarker」として書くので、変更履歴パネルで1件ずつ却下できます(消した脚注や表も一緒に戻ります)。Story モードで変更の行を右クリックし「Reject This Import Change」を選ぶと、その行の Import の変更だけを取り消せます。Word で行・列・結合を変えた表は変更履歴に残せないので Import せず、! で示します。ルビ・圏点・縦中横・割注は変更履歴に載らないので、Source 文書から戻してください。"
		...
		u"・変更を文書に書き戻すメニューはありません(「Restore Source Text」「Undo the Restore」"
		u"「Restore All in This Story」は 2026-09-21 に廃止)。"
		u"旧版の文字が要るときは、Source の文書から直接コピーしてください。"
