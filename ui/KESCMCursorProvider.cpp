...
//  画像は KESCMCheckGlyph.h と同じ幾何(頂点 5,12 - 10,18 - 20,5 / halo 4.2(active) or 5.0(inactive) /
//  body 2.4 / 丸端)で生成したもの: KESCM_Check_10_18.png(黒✓) / KESCM_CheckOff_10_18.png(白抜き✓)、
//  各 @2x / @3to2x。
//  ⚠halo は 2026-08-19(不具合再検査 B-U6)まで「3.5 or 5.0」と書いてあったが、**3.5 は
//    2026-07-25 にユーザー要望で 4.2 へ太くする前の値**。KESCMCheckGlyph.h の既定値も
