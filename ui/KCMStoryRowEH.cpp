...
// pops kKCMChangeRowMenuName (2026-09-12; "Restore Source Text", and in the Import mode the same
// command under the name "Change to Imported Text"). Neither row is offered the other's.
