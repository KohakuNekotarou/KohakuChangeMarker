...
//      separate flags (alwaysScreen and sMarksTempHidden, both in KCMDrawEventHandler).
//
...
//  (source/KCMStoryMarker.cpp), because **the UI's File > Export > PDF runs in the background and
...
//    one call through IKCMStoryMarkFacade. Everything the comments above describe still happens,
...
#ifndef __KCMStoryPressMarks_h__
#define __KCMStoryPressMarks_h__
...
#endif // __KCMStoryPressMarks_h__

// End, KCMStoryPressMarks.h.
