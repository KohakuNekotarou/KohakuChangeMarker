...
//    KCMBookPair     - WHICH two books (and which chapter pairs up with which)
//    KCMBookCompare  - HOW they are compared
//    KCMBookRun      - the COMMAND: confirm, run, hand the result over, open the dialog
//    KCMBookDialog   - the VIEW: paints what it was handed
//
//========================================================================================
#ifndef __KCMBookRun_h__
#define __KCMBookRun_h__
...
/** The flyout item "Compare Books".
    ...
    that case anyway - both use KCMResolveBookPair - but the grey state is decided when the menu
    is built and this runs when it is chosen, and the front tab can change in between. */
void KCMRunBookComparison();

#endif // __KCMBookRun_h__
