...
#define kKCMChangeRowImportMenuKey	kKCMStringPrefix "kKCMChangeRowImportMenuKey"		// the "Import Source Text" item - the same action under the name the Import mode calls for (2026-09-15)
...
#define kKCMChangeRowImportMenuItemPosition		2.5	// CHANGE row context menu: "Import Source Text" - the same place, in the mode where the item is called that. ★The two are never live together, so what this number really decides is where a future item would sit between them
