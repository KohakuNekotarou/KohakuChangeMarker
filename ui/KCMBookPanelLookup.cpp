...
//
//  The front-tab walk. See KCMBookPanelLookup.h for why it lives on this side.
//
//  Moved here from the model half's KCMBookPair.cpp on 2026-08-15 (Stage 2, Task 9B).
