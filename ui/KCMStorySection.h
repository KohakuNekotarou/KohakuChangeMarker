...
#ifndef __KCMStorySection_h__
#define __KCMStorySection_h__
...
/** Show the Story Edits section if it is hidden, hide it if it is showing, and resize the panel
	...
	widget and persists across restarts (kKCMStorySectionPanelBoss in KCMUI.fr). Closing always
	...
	★The 185 there is the top pane, and it still is: it was 230 for part of 2026-09-09 and came
	back the same day, when the Resources value band moved into the message area. Left as
...
#endif // __KCMStorySection_h__

// End, KCMStorySection.h.
