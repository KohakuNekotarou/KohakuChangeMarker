...
//    KESCMDrawEventSrvc がまさにそれで、**第2段で消す対象**)」だったが、**その手書き override は
//    2026-08-14 に撤去済み**＝model 側 KESCMDrawEventHandler.cpp の KESCMDrawEventSrvc が
//    「第2段を待たず先に消してある」と自分で書いている。**このファイルが書かれた翌日**に片付いた
//    予告を、第2段の完了(2026-08-15)後も持ち続けていた。
//    ⇒ ★**段階実装の「まだ」は、その段階が終わった日に消す**(同じ B-U2 の回に
//      KESCMModelChangeObserver.cpp で拾った教訓の、同じブロック内での再発)。
//
//========================================================================================
