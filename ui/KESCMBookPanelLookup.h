...
//
//  This code lived in the model half (KESCMBookPair.cpp) until 2026-08-15. Stage 2 Task 9B took
...
//
//      KESCMBookPair.obj : error LNK2019: unresolved external symbol
//      "PaletteRefUtils::IsPaletteVisible(class PaletteRef const &)"
//      referenced in function "KESCMGetPanelBookFile(class IDFile &)"
//
//  Stage 1 had already written this down as a known debt (IKESCMBookFacade.h: "KNOWN, AND LEFT TO
...
//  registered panels and reports a file); KESCMResolveBookPair still DECIDES (that file's book is
...
//
//========================================================================================
#ifndef __KESCMBookPanelLookup_h__
#define __KESCMBookPanelLookup_h__
...
/** The book whose tab is in FRONT in the Book panel.
    ...
    ***** This deliberately does NOT fall back to the active book. ***** IBookManager's active book
    ...
    Pass the result to IKESCMBookFacade::ResolveBookPair. An empty/failed answer means "do not
...
#endif // __KESCMBookPanelLookup_h__

// End, KESCMBookPanelLookup.h.
