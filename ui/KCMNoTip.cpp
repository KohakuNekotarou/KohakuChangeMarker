...
//  kKCMStoryRowCellBoss が IID_ITIP にこの実装を名指しして、沈黙を手に入れる。
//
//  ★基底が AbstractTip なのは KCMIconTip.cpp と同じ理由(製品コードのツールチップが例外なく
//  継承している基底で、UpdateToolTipOnMouseMove と SetTipText を供給してくれる)。そちらの
//  ファイル冒頭に経緯が全部書いてある。
//
//  この一覧に固有のものは何も無い ---- 要らないツールチップを継承してしまった KCM の widget は、
//  どれでもこの実装を名指しできる。
//
//========================================================================================
