...
#define kKESCMVersion		"1.4.0"						// Version of this plug-in。About ボックス本文・.rc の FileVersion・PluginVersion リソースの3か所に出る。1.0.1 → 1.1.0(2026-07-25) → 1.1.1(2026-07-26) → 1.2.0(2026-07-30) → 1.2.1(2026-08-06) → 1.3.0(2026-08-07) → 1.3.1(2026-08-07) → 1.4.0(2026-08-09)。
														// ★1.4.0 で minor を上げた理由 = **新機能 Story Edits**(パネル下部に開閉セクションを設け、変更のあったストーリーを一覧する)。1.2.1→1.3.0 のときと同じ基準＝機能追加が入るなら patch では足りない。⚠**Story Edits はまだ作りかけ**(下記③)。
														...
														//   ③★★**Story Edits(パネル下部の開閉セクション) = minor を上げた理由。⚠2026-08-09 時点で作りかけ＝完成するまで提出説明に書かないこと。**
														...
														//     現況: 段階1(計測)と段階2(開閉セクションの器)は完了。段階3(ツリーと行の表示)は Task 1・2 まで。段階4(ジャンプ)は未着手。計画=docs/superpowers/plans/2026-08-09-kescm-story-edits-stage3.md／設計=docs/superpowers/specs/2026-08-09-kescm-story-edit-section-design.md
