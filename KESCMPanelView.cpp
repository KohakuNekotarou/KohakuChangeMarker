...
//
//  Story Edits を閉じているときのパネルは上ペインだけ ---- 固定座標のコントロールが並んだ 173px の
//  塊で、その下には何も無い。伸ばせるようにすると空白の帯ができるだけなので、閉じている間は
//  173px ちょうどに留める(ユーザー判断 2026-08-10)。開いている間は、上ペイン＋セクションの最小まで
//  縮められる。
//
//  ★セクションの最小は**数字で書かない**。分割バーに Bottom snap を聞く ---- その値は .fr が
//  持っており(KESCM.fr の SplitterPanelWidget)、KESCMStorySection.cpp も同じ聞き方で開く高さの
